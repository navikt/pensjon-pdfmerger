...
data class Documentinfo(val filename: String, val dokumenttype: String, val fagomrade: String,
                        ...
                        val mottattSendtDato: LocalDate, val file: ByteArray, val vedleggList: List<VedleggDokument>)

data class VedleggDokument(val filename: String, val documentName: String, val file: ByteArray)